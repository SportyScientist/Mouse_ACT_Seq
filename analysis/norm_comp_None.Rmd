---
title: "ACTSeq H3K27ac not normalized"
...
data <-read.table("/omics/groups/OE0219/internal/ganslm/Analysis/Mouse_ActSeq/bw_comparison/None/mbw_summary_10kb_None.mat", stringsAsFactors=FALSE, header=TRUE, comment.char="!")
...
saveRDS(sum_full_datax, "output/datasummed_none.rds")
```


```{r None, results='asis', eval = T}
