---
title: "ACTSeq H3K27ac RPKM Normalized"
...
data <-read.table("/omics/groups/OE0219/internal/ganslm/Analysis/Mouse_ActSeq/bw_comparison/RPKM/mbw_summary_10kb_RPKM.mat", stringsAsFactors=FALSE, header=TRUE, comment.char="!")
...
plot_seperate <- sums %>%
  ...
  theme(axis.text.y = element_blank(),
        ...
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank())+
  facet_grid(Sample~replicate, drop = T)+
  theme(strip.background=element_rect(fill="white"))
