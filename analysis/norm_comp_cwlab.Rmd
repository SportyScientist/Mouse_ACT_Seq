---
title: "ACTSeq H3K27ac cwlab Normalized"
...
```{r cwlab, results='asis'}
#read in matrix from multiBigWigSummary
  
data <-read.table("/omics/groups/OE0219/internal/ganslm/Analysis/Mouse_ActSeq/bw_comparison/cwlab/mbw_summary_10kb_cwlab.mat", stringsAsFactors=FALSE, header=TRUE, comment.char="!")
...
saveRDS(sum_full_data, "output/datasummed_norm_cwlab.rds")
