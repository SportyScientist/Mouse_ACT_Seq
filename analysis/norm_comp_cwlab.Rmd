---
title: "ACTSeq H3K27ac BPM Normalized"
...
data <-read.table("/omics/groups/OE0219/internal/ganslm/Analysis/Mouse_ActSeq/bw_comparison/BPM/mbw_summary_10kb_BPM.mat", stringsAsFactors=FALSE, header=TRUE, comment.char="!")
...
saveRDS(sum_full_datax, "output/datasummed_norm_cwlab.rds")
```


```{r cwalb, results='asis', eval = T}

sum_full_datax <- readRDS("output/datasummed_norm_CPM.rds")
