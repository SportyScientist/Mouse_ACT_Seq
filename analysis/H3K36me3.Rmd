...
data_10kb <-read.table("/omics/groups/OE0219/internal/ganslm/Analysis/Mouse_ActSeq/New/RPKM_bigwigs/H3K36me3/mbw_summary_10kb_H3K36me3.mat", stringsAsFactors=FALSE, header=TRUE, comment.char="!")

data_1kb <-read.table("/omics/groups/OE0219/internal/ganslm/Analysis/Mouse_ActSeq/New/RPKM_bigwigs/H3K36me3/mbw_summary_1kb_H3K36me3.mat", stringsAsFactors=FALSE, header=TRUE, comment.char="!")
...
saveRDS(sum_full_data, "output/datasummedH3K36me3.rds")
```


```{r results='asis'}

#sum_full_data <- readRDS("output/datasummedH3K36me3.rds")
