...
#mats <- list.files("/omics/groups/OE0219/internal/ganslm/Analysis/Mouse_ActSeq/New/matrix",
 #          pattern = glob2rx("*_mbw_summary_10kb_cwlab_wfl.mat"),
  #                       recursive = F, 
   #                      full.names = TRUE)

#read in matrix from multiBigWigSummary
  
data <-read.table("/omics/groups/OE0219/internal/ganslm/Analysis/Mouse_ActSeq/New/matrix/H3K36me3_mbw_summary_10kb_cwlab_wfl.mat", stringsAsFactors=FALSE, header=TRUE, comment.char="!")
